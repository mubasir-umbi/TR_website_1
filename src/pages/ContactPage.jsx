...
<p className="text-md lg:text-xl md:text-xl text-center text-gray-900_87 sm:text-xl w-auto font-montserrat font-semibold">PREFER TO TALK?</p>
  <ScheduleCall/>
   ...
   {/* <Link to={'/schedule'} className="text-lg lg:text-2xl sm:text-[20px] text-center text-gray-900 underline w-auto font-montserrat font-semibold">Schedule a call</Link>  */}

{/* <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Schedule%20a%20Call" className="text-lg lg:text-2xl sm:text-[20px] text-center text-gray-900 underline w-auto font-montserrat font-semibold">Schedule a call</a>  */}
