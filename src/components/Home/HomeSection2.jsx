...
const HomeSection2 = () => {
    ...
    return (
        <>
            <div className="flex flex-col items-start justify-start w-auto md:w-full mb-16 "
                ref={serviecesRef}
            >
                <div className="bg-black-900_02 flex flex-col items-start justify-end px-4 sm:px-8 w-full pb-24">

                    <div className="flex flex-col font-montserrat items-start justify-start mb-1 mt-[30px] mx-auto w-full">


                        <div className='px-5 pt-10 md:pt-20 md:pl-14'>
