...
function WhatWeDo() {
  return (
    <div className='bg-gray-900 py-20 px-10 md:py-36'>
    <div className="md:ml-[36px] md:gap-[24px] fontMontserrat text-left font-black text-3xl md:text-[32px] leading-[2.5rem] md:leading-[51.2px] tracking-[-3%]  text-white-A700">
        WHAT WE DO AND <br /> <span className='text-gray-500'> WHY WE DO IT</span>
    </div>

    <div className="md:ml-[36px] fontMontserrat text-white-A700 text-left text-sm md:text-lg font-normal leading-5 tracking-wide mt-7 max-w-[500px] md:max-w-[700px]">
